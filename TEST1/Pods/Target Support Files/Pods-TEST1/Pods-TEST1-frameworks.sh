...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/AAALib/AAALib.framework"
  install_framework "$BUILT_PRODUCTS_DIR/AFNetworking/AFNetworking.framework"
  install_framework "$BUILT_PRODUCTS_DIR/BBBLib/BBBLib.framework"
  install_framework "$BUILT_PRODUCTS_DIR/CCCLib/CCCLib.framework"
